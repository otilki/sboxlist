 ...
 private:
	 ...
	 void steal_ownership(RandomAccessVector& x) noexcept{
 ...
 public:
	 ...
	 explicit RandomAccessVector(const allocator_type& allocator = allocator_type(), const offset_by_type& offset_by = offset_by_type())
	 ...
	 explicit RandomAccessVector(const offset_by_type& offset_by)
	 :RandomAccessVector(allocator_type(), offset_by)
	 {}
	 ...
	 RandomAccessVector(size_type n, const_reference val, const offset_by_type& offset_by)
	 :RandomAccessVector(n, val, allocator_type(), offset_by)
	 {}
 
 #if __cplusplus < 201402L
	 explicit RandomAccessVector(size_type n)
	 :RandomAccessVector(n, value_type())
	 {}
 #else
	 explicit RandomAccessVector(
		 size_type n,
		 const allocator_type& allocator = allocator_type(),
		 const offset_by_type& offset_by = offset_by_type()
	 )
	 :RandomAccessVector(n, value_type(), allocator, offset_by)
	 {}
 #endif
	 ...
	 :RandomAccessVector(first, last, distance, allocator_type(), offset_by)
	 {}
	 ...
	 :RandomAccessVector(allocator, offset_by)
	 {
	 ...
	 :RandomAccessVector(first, last, allocator_type(), offset_by)
	 {}
 
	 RandomAccessVector(const RandomAccessVector& x, const allocator_type& allocator, const offset_by_type& offset_by)
	 :RandomAccessVector(x.begin(), x.end(), x.size(), allocator, offset_by)
	 {}
 
	 RandomAccessVector(const RandomAccessVector& x, const allocator_type& allocator)
	 :RandomAccessVector(x.begin(), x.end(), x.size(), allocator, x.offs)
	 {}
 
	 RandomAccessVector(const RandomAccessVector& x, const offset_by_type& offset_by)
	 :RandomAccessVector(x.begin(), x.end(), x.size(), x.alloc, offset_by)
	 {}
 
	 RandomAccessVector(const RandomAccessVector& x)
	 :RandomAccessVector(x, al_traits<allocator_type>::select_on_container_copy_construction(x.alloc), x.offs)
	 {}
 
	 RandomAccessVector(RandomAccessVector&& x) noexcept
	 :RandomAccessVector(std::move(x), x.alloc, x.offs)
	 {}
 
	 RandomAccessVector(RandomAccessVector&& x, const allocator_type& allocator, const offset_by_type& offset_by) noexcept
	 :offs(offset_by)
	 {
	 ...
	 RandomAccessVector(RandomAccessVector&& x, const allocator_type& allocator) noexcept 
	 :RandomAccessVector(std::move(x), allocator, x.offs)
	 {}
 
	 RandomAccessVector(RandomAccessVector&& x, const offset_by_type& offset_by) noexcept
	 :RandomAccessVector(std::move(x), x.alloc, offset_by)
	 {}
	 ...
	 :RandomAccessVector(il.begin(), il.end(), il.size(), allocator, offset_by)
	 {}
 
	 RandomAccessVector(std::initializer_list<value_type> il, const offset_by_type& offset_by)
	 :RandomAccessVector(il.begin(), il.end(), il.size(), allocator_type(), offset_by)
	 {}
	 ...
	 RandomAccessVector& operator=(const RandomAccessVector& x){
		 if(this == &x){
			 return *this;
		 }
	 ...
	 RandomAccessVector& operator=(RandomAccessVector&& x){
		 if(this == &x){
			 return *this;
		 }
	 ...
	 RandomAccessVector& operator=(std::initializer_list<value_type> il){
		 if(offs.capacity < il.size()){
			 destroy_all();
			 deallocate();
	 ...
	 void swap(RandomAccessVector& x){
 ...
 bool operator== (const RandomAccessVector<T, Alloc, OffsetByA>& lhs, const RandomAccessVector<T, Alloc, OffsetByB>& rhs){
 ...
 template<class T, class Alloc, class OffsetByA, class OffsetByB>
 void swap(RandomAccessVector<T, Alloc, OffsetByA>& x, RandomAccessVector<T, Alloc, OffsetByB> y){
	 x.swap(y);
 }
 } //rdsl
