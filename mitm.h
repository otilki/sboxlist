...
//#define RandomAccessSet set
//#define RandomAccessVector vector
...
#include <algorithm>
#include <iostream>
#ifdef RandomAccessVector
#include <vector>
#endif
#ifndef RandomAccessVector
#include "svector.h"
#endif
...
#include <map>
#include <stdexcept>
#ifndef RandomAccessSet
#include "sset.h"
#endif

#ifdef RandomAccessSet
#include <set>
#endif
#include <cmath>
#include "omp.h"
...
*/
void expand(map<int, RandomAccessSet<function_t> > *g_curr,
            map<int, RandomAccessSet<function_t> > *g_opp,
            int lambda);
...
*/
void v_list_process(int lambda,int op_cost, RandomAccessVector<function_t> *tmp,    map<int, RandomAccessSet<function_t> > *current,
...
void get_implementation(function_t f1,
                        function_t f2,
                        int v,
                        map<int, RandomAccessSet<function_t> > *g1,
                        map<int, RandomAccessSet<function_t> > *g2);
/*
...
*/
void bool_op_fun( int op_id, function_t f, RandomAccessVector<function_t> *v);
string bool_op_to_string(const function_t f, uint8_t op, bool reverse, bool qiskit);

string bit_slice(array<uint16_t, 4> *sbox);
void exit_m();
void print_graphe_info();
void graphe_to_file(map<int, RandomAccessSet<function_t> > *graphe, string graphe_name);
