...
void bool_op_simple_gates(function_t f, RandomAccessVector<function_t> *v, int operation)
{
...
void bool_op_double_gates(function_t f, RandomAccessVector<function_t> *v, int operation)
{
